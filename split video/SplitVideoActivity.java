...
public class SplitVideoActivity extends AppCompatActivity implements MediaPlayer.OnCompletionListener {
    ...
    public File folder;
    private final String SPLIT_VIDEO = "Split Video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Constants.UPLOAD_TRIGGER_COUNT(getClass().getSimpleName());
...
//        saveVideos(videoFiles);
    ...
    public void shareMultipleVideo(Context context, ArrayList<String> videoFiles, String title) {
        ...
        NotificationScheduler.scheduleReviewNotification(SplitVideoActivity.this);
        ...
        runOnUiThread(() -> {
            new AlertDialog.Builder(SplitVideoActivity.this)
                    ...
                    .setNegativeButton("Save", (dialog, which) -> {
                        ...
                        dialog.dismiss();
                    }).setTitle("Video Split Completed").setMessage("Do you want to share it now to WA or save the videos?")
                    .show();
        });
    }
